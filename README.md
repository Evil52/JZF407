...
**Active-LOW:** реле включается когда STM32 выдаёт `0` (LOW). После reset STM32 выводит HIGH → реле автоматически OFF. Логика в `outputs.c` инвертирует — снаружи всегда `1 = ВКЛ, 0 = ВЫКЛ`.
